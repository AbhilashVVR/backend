...
const tableName = 'websiteGameQues';

function createWebsiteGameQuestionTable() {
...
const registerWebsiteGameQuestions = async (websiteGameQuestionDetails) => {

    var params = {
        TableName: tableName,
        Item: websiteGameQuestionDetails
    };
...
const getWebsiteGameQuestions = async () => {
...
const getWebsiteGameQuestionsByGameId = async (gameId) => {
...
const getWebsiteGameQuestionByLevelAndGameId = async (gameId, level) => {
...
const getWebsiteGameQuestionById = async (id) => {
    var params = {
        TableName: tableName,
        Key: {
            "id": id,
...
//deleteTable()
//createWebsiteGameQuestionTable()
